...
int main(int argc, char *argv[]) {
    ...
    VoronoiParams voronoiParams = {
            .nInitialCells = 16,
            .nCells = 4,
            .imagePath = strdup("../images/voronoi/fin/"),
            .imagePathPre = strdup("../images/voronoi/pre/"),
            .imagePathRem = strdup("../images/voronoi/rem/"),
            .imagePathMerged = strdup("../images/voronoi/merged/"),
            .srgImagePathBase = strdup("../images/voronoi/srg/"),
            .srgImagePath = strdup("../images/voronoi/srg/"),
            .statsPath = strdup("../voronoi_stats.csv"),
            .srgPrecision = 100,
    ...
    SplineParams splineParams = {
            ...
            .nPoints = 128,
            .nSplines = 5,
            .imagePath = strdup("../images/spline/"),
            .srgImagePathBase = strdup("../images/spline/srg/"),
            .srgImagePath = strdup("../images/spline/srg/"),
            .statsPath = strdup("../spline_stats.csv"),
            .srgPrecision = 100,
